...
I work on quantum learning theory, large language models (dynamics, and the applications in quantum), and applying physical principles to analyze neural network dynamics. I am interested in leveraging principles or tools from physics for AI dynamics (e.g., fine-tuning dynamics, grokking, emergent abilities, neural scaling law, catapult dynamics, etc.)/applications and AI for quantum.
